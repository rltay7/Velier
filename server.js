...
let listings = [
  ...
  // ── DRESSES ──
  { id: 7, title: 'Valentino Garavani VLogo Silk Gown', brand: 'Valentino', category: 'Dresses', location: 'Paris, France', description: 'A floor-length silk crépe gown from Valentino\'s archival collection, featuring the bold VLogo at the waist. Deep fuchsia, draped with architectural precision. Perfect for a gala, dinner, or wherever you need to be unforgettable.', daily_rate: 145, condition: 'Excellent', colour: 'Fuchsia Pink', size: 'UK 10 / IT 42', image: 'https://www.net-a-porter.com/variants/images/1647597277246856/ou/w2000_q60.jpg', owner_id: 5, featured: true, rating: 4.9, reviews: 17, wishlist_count: 203 },
