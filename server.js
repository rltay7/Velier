...
let listings = [
  ...
  { id: 3, title: 'Chanel Classic Double Flap Bag', brand: 'Chanel', category: 'Bags', location: 'London, UK', description: 'The most coveted bag in the world. This Chanel Classic Double Flap in lambskin with gold hardware is the ultimate statement of refined elegance. The interlocking CC lock, quilted stitching, and chain strap are timeless.', daily_rate: 195, condition: 'Excellent', colour: 'Ivory', size: 'Medium', image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800&q=85', owner_id: 3, featured: true, rating: 4.9, reviews: 41, wishlist_count: 312 },
  ...
  { id: 5, title: 'Hermès Birkin 30 Togo Leather', brand: 'Hermès', category: 'Bags', location: 'Paris, France', description: 'The bag that needs no introduction. This Hermès Birkin 30 in Togo calfskin with palladium hardware. Structured, spacious, and timeless. Colour: Biscuit. Originally purchased at the Hermès flagship, Paris.', daily_rate: 450, condition: 'Excellent', colour: 'Biscuit', size: '30cm', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&q=85', owner_id: 9, featured: true, rating: 5.0, reviews: 38, wishlist_count: 612 },
  { id: 6, title: 'Saint Laurent Le 5 à 7 Hobo Bag', brand: 'Saint Laurent', category: 'Bags', location: 'Vienna, Austria', description: 'The Saint Laurent Le 5 à 7 in supple smooth leather with an adjustable strap. Named for the quintessential French cinq à sept. Subtle YSL cassandre logo hardware. Effortless Parisian cool.', daily_rate: 90, condition: 'Very Good', colour: 'Noir', size: 'Large', image: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=800&q=85', owner_id: 10, featured: false, rating: 4.6, reviews: 26, wishlist_count: 143 },

  // ── DRESSES ──
  { id: 7, title: 'Valentino Garavani VLogo Silk Gown', brand: 'Valentino', category: 'Dresses', location: 'Paris, France', description: 'A floor-length silk crépe gown from Valentino\'s archival collection, featuring the bold VLogo at the waist. Deep fuchsia, draped with architectural precision. Perfect for a gala, dinner, or wherever you need to be unforgettable.', daily_rate: 145, condition: 'Excellent', colour: 'Fuchsia Pink', size: 'UK 10 / IT 42', image: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=85', owner_id: 5, featured: true, rating: 4.9, reviews: 17, wishlist_count: 203 },
  { id: 8, title: 'Alexander McQueen Skull Scarf Dress', brand: 'Alexander McQueen', category: 'Dresses', location: 'Geneva, Switzerland', description: 'An archival Alexander McQueen skull-print chiffon dress in the signature skull scarf motif. Floaty, subversive, and unmistakably McQueen. Fully lined, with delicate flutter sleeves.', daily_rate: 125, condition: 'Excellent', colour: 'Ivory/Black', size: 'UK 12 / IT 44', image: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&q=85', owner_id: 12, featured: false, rating: 4.7, reviews: 15, wishlist_count: 98 },

  // ── JEWELLERY ──
  { id: 9, title: 'Cartier Love Bracelet 18k Yellow Gold', brand: 'Cartier', category: 'Jewellery', location: 'Madrid, Spain', description: 'The quintessential Cartier Love Bracelet in 18-karat yellow gold. Designed by Aldo Cipullo in 1969, this iconic cuff fastens with a small screwdriver — a symbol of eternal love. Arrives with the original gold screwdriver.', daily_rate: 175, condition: 'Excellent', colour: 'Yellow Gold', size: 'Size 17', image: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=800&q=85', owner_id: 8, featured: true, rating: 4.9, reviews: 44, wishlist_count: 521 },
